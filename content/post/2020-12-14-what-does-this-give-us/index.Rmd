...
votes_data <- votes_data %>% mutate(votes = suppressWarnings(as.numeric(value))) %>% 
  ...
  #/Users/irm16/Dropbox/Blogdown Sites/irm_v1/R/Voting_Precinct
  #generate maps
```

```{r build the map layers:  hardcoded for presidential race}
h <- st_read("/Users/irm16/Dropbox/Blogdown Sites/irm_v1/R/Voting_Precinct/VotingPrecinct.shp")
